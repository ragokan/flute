...
Route<dynamic>? pageRouteBuilder(RouteSettings settings) {
  ...
  /// We will check all of [Flute.app.routes] which are the [route] list
  /// that is defined at [FluteMaterialApp] or [FluteCupertinoApp].
  ///
  ...
  /// route or not.
  Flute.app.routes.forEach((route, value) =>
  ...
  if (_targetPage != null) {
    ...
    if (Flute.app.routes.containsKey('/notFound')) {
      Flute.pushNamed('/notFound');
    }
  }
}
