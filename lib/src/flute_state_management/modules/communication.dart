...
class _CustomControllerStream<Flute> {
  ...
  Function watch<T extends Flute>(
    T controller,
...
///
/// In the flute, we don't use Dependency Injection, instead we use
...
final _CustomControllerStream controllerXviewStream =
    _CustomControllerStream<FluteController>();
