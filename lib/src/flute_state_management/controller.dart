...
/// [FluteController] is the head of flute state management.
///
/// To use this, you should extend or mix your controller class.
///
/// [FluteController] gives you two important functions, [update] and [setState]
...
///
/// ```
class FluteController with FluteStateMethods {
  /// The constructor of [FluteController], luckily it is constant!
  const FluteController();
