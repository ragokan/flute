...
/// [FluteMaterialApp] is the replacement of [MaterialApp] to use
/// all of [Flute] features in your app!
class FluteMaterialApp extends StatelessWidget {
  /// The constant constuctor of [FluteMaterialApp].
  const FluteMaterialApp({
    Key? key,
