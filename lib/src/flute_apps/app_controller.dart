...
import '../../flute.dart';
import '../flute_utilities/route_utilities/dynamic_routing.dart';

/// The root controller of [FluteMaterialApp] and [FluteCupertinoApp].
///
/// This controller is already injected to the Flute. You can use it by
/// ```dart
/// Flute.app
/// //or
/// Flute.use<AppController>()
/// ```
class AppController extends FluteController {
  // Material
  ...
  /// Returns the current app, if you used [FluteMaterialApp], it will be true,
  /// if you used [FluteCupertinoApp], it will be false.
  ///
  /// We do use this parameter in routing animations.
  bool isMaterial = true;

  /// These [routes] are the main [routes] of the [FluteMaterialApp] or
  /// [FluteCupertinoApp], we don't do any change here, we just save it.
  ///
