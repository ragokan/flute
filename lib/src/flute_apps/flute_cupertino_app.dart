...
import '../flute_instance.dart';
import '../flute_utilities/flute_observer.dart';
import 'app_controller.dart';

// TODO: Add documents here.

/// [FluteCupertinoApp] is the replacement of [CupertinoApp] to use
/// all of [Flute] features in your app!
class FluteCupertinoApp extends StatelessWidget {
  /// The constant constuctor of [FluteCupertinoApp].
  const FluteCupertinoApp({
    Key? key,
    this.home,
    this.theme,
    this.routes,
  ...
  /// navigatorObservers. You don't need to do this for Flute.
  ...
  /// Default locale that your app will use for [Flute] localizations.
  final Locale? locale;
  ...
  Widget build(BuildContext ctx) {
    if (routes != null) Flute.app.routes = routes!;
    Flute.app.isMaterial = false;
    if (locale != null && Flute.app.locale == null) Flute.app.locale = locale;
    Flute.app.translations = translations;

    final navigatorKey = Flute.navigatorKey;
    final _navigatorObservers = navigatorObservers == null
        ? <NavigatorObserver>[FluteObserver()]
        : <NavigatorObserver>[FluteObserver(), ...navigatorObservers!];
    return Fluto<AppController>((app) => routerDelegate == null
        ? CupertinoApp(
            ...
            onGenerateRoute: Flute.app.onGenerateRoute,
            onGenerateTitle: onGenerateTitle,
            onUnknownRoute: onUnknownRoute,
            routes: Flute.app.routes,
